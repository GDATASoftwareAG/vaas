...
final class VaasTest extends TestCase
{
    ...
    {
        $uuid = $this->getUuid();
        $vaas = (new Vaas())->ConnectWithCredentials(
            $_ENV['CLIENT_ID'],
            $_ENV['CLIENT_SECRET'],
            $_ENV["TOKEN_URL"],
            $_ENV["VAAS_URL"],
    ...
    public function testConnectionWithInvalidCredentials_ThrowsAccessDeniedException(): void {
        $this->expectException(AccessDeniedException::class);
        (new Vaas)->ConnectWithCredentials(
            "Invalid",
            "invalid",
            $_ENV["TOKEN_URL"],
            $_ENV["VAAS_URL"],
    ...
    public function testConnectionWithInvalidToken_ThrowsAccessDeniedException(): void {
        $this->expectException(AccessDeniedException::class);
        (new Vaas)->ConnectWithToken(
            "Invalid",
            $this->_getDebugLogger());
    }
