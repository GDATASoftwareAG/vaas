...
public static class Program
{
    ...
    private static string UserName => Environment.GetEnvironmentVariable("USER_NAME") ?? string.Empty;
    private static string Password => Environment.GetEnvironmentVariable("PASSWORD") ?? string.Empty;
